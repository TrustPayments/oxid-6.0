	...
	<li>
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				[{if $order->getTrustPaymentsDownloads()}]
				<strong>[{oxmultilang ident="tru_trustPayments_Downloads"}]</strong>
				<ul class="list-unstyled">
					[{foreach from=$order->getTrustPaymentsDownloads() item=trudownload}]
					<li><a href="[{$trudownload.link}]">[{$trudownload.text}]</a></li>
					[{/foreach}]
				</ul>
				[{/if}]
			</div>

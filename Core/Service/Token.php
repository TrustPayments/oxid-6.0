...
class Token extends AbstractService
{
    ...
    {
        $token = oxNew(\Tru\TrustPayments\Application\Model\Token::class);
        /* @var $token \Tru\TrustPayments\Application\Model\Token */
    ...
    protected function getTokenVersionService()
    {
        if ($this->versionService == null) {
            $this->versionService = new \TrustPayments\Sdk\Service\TokenVersionService(TrustPaymentsModule::instance()->getApiClient());
        }
